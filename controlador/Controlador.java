...
public class Controlador implements ActionListener
{
    ...
    //------------
        ...
        public Controlador(VentanaPrincipal pVista, Equipo pModelo, Jugador pModelo2)
        {
            ...
            this.vista.miPanelOperaciones.btTenico.addActionListener(this);
        ...
        public void actionPerformed(ActionEvent ae) 
        {
            ...
            {
                String nombre = vista.miDialogoTecnico.getNombre();
                int experiencia = Integer.parseInt(vista.miDialogoTecnico.getExperiencia());
                int dia = Integer.parseInt(vista.miDialogoTecnico.getDia());
                int mes = Integer.parseInt(vista.miDialogoTecnico.getMes());
                int año = Integer.parseInt(vista.miDialogoTecnico.getAño());
                ...
                vista.miDialogoTecnico.cerrarDialogo();
            }
            ...
            if(comando.equals("tecnico"))
            {   
                 vista.crearDialogoTecnico();
                 this.vista.miDialogoTecnico.agregarOyentesBotones(this);
            }
